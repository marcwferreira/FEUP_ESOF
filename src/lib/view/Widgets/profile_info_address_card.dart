...
/// Manages the profile info and contains student's addresses
class ProfileInfoAddressCard extends GenericCard {
  ProfileInfoAddressCard({Key key, this.name});
    ...
    return Column(
      ...
      children: <Widget>[
        Table(
            ...
            children: [
              tableRow(profileInfo.residenciaOficial, context),
              tableRow(profileInfo.residenciaAulas,context),
            ]),
      ],
    );
  }
