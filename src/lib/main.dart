...
import 'package:uni/view/Pages/search_people_page.dart';
import 'package:uni/view/navigation_service.dart';
import 'package:uni/view/theme.dart';
import 'globals.dart' as ProfileInfo;
      ...
      child: MaterialApp(
          ...
          onGenerateRoute: (RouteSettings settings) {
            switch (settings.name) {
              ...
              case '/' + Constants.navMultiDec:
                return PageTransition.makePageTransition(
                    page: MultiDecPageView(),
                    settings: settings,
                    maintainState: false);
              case '/' + Constants.navSearchPage:
                return PageTransition.makePageTransition(
                    page: searchPageView(), settings: settings);
